...
print_ctrl = {"print_cost": True, "print_parameter": False, "iterations": 100}
parameters = L_layer_model(train_x, train_y, layers_dims, num_iterations=2500, print_ctrl=print_ctrl,
